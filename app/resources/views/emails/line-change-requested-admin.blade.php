@extends('emails.layouts.branded', [
    ...
    'previewText' => 'Distributor '.$requesterAdn.' requested a Genos-placement change.',
])
...
<p style="margin: 0 0 18px 0; font-size: 14px; line-height: 22px; color: #374151;">
    This will move the requester's <strong>Genos placement only</strong>; their sponsor is unchanged.
</p>

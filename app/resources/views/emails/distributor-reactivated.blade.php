@extends('emails.layouts.branded', [
    ...
    'previewText' => 'Your distributor account '.$adn.' is active again.',
    'accentColor' => '#047857',
    'accentDarker' => '#065f46',
])
    ...
    <tr>
        <td>
            <p class="ar-h1" style="margin: 0 0 18px 0; font-size: 22px; line-height: 28px; font-weight: 700; color: #111827;">
                Your distributor account has been reactivated
            </p>
            ...
            <p style="margin: 0 0 14px 0; font-size: 15px; line-height: 24px; color: #374151;">
                ...
                was set active again on <strong style="color: #111827;">{{ $reactivatedAtFormatted }}</strong>.
            </p>

...
<form method="POST" action="{{ route('admin.compensation.manual-controls.reverse') }}"
    ...
    <div class="mb-4">
        <label class="block text-xs font-medium text-gray-700 mb-1">Reason (required, min 10 chars) <x-help-tip text="Why the GSB credit is being reversed. Recorded in the audit log." /></label>

    ...
    <table class="w-full text-xs">
        <thead class="bg-gray-50">
            <tr>
                ...
                <x-bonus-credit-head th-class="px-3 py-2 text-right text-gray-600" :repurchase="false" />
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr>
                ...
                <x-bonus-credit-cells td-class="px-3 py-2 text-right" :repurchase="false" :gross="$row->gross_paise" :credited="$row->net_paise" />

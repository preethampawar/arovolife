...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
    ...
    <p class="px-6 py-8 text-sm text-gray-400 text-center">No Fortune Bonus history yet.</p>
    @else
    <table class="w-full text-xs">
        <thead class="bg-gray-50">
            <tr>
                <th class="px-3 py-2 text-left text-gray-500">Month</th>
                <th class="px-3 py-2 text-center text-gray-500">Position <x-help-tip text="The distributor's FCFS position in the month's Fortune matrix." /></th>
                <th class="px-3 py-2 text-center text-gray-500">Level</th>
                <th class="px-3 py-2 text-right text-gray-500">Points</th>
                <th class="px-3 py-2 text-right text-gray-500">Point value</th>
                <th class="px-3 py-2 text-right text-gray-500">Cap</th>
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr>
                ...
                <td class="px-3 py-2 text-right text-gray-500">
                    @if($row->cap_paise !== null)₹{{ \App\Modules\Shared\Support\IndianNumber::format($row->cap_paise / 100, 0) }}@else<span class="text-gray-400">—</span>@endif
                </td>

    ...
    <table class="w-full text-xs">
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr>
                ...
                <td class="px-3 py-2 text-right">₹{{ \Illuminate\Support\Number::format($row->sponsee_gsb_paise / 100, 2) }}</td>
                ...
                <td class="px-3 py-2 text-right text-gray-500">₹{{ \Illuminate\Support\Number::format($row->sponsee_cumulative_gsb_paise / 100, 2) }}</td>

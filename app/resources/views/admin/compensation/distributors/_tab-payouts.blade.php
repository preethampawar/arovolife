    ...
    <table class="w-full text-xs">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-3 py-2 text-right text-gray-600">Repurchase deduction <x-help-tip text="10% of prior month GSB+MB+RB, capped ₹10,000." /></th>
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            @php
                $lc = ['transferred' => 'bg-green-100 text-green-700', 'failed' => 'bg-red-100 text-red-700', 'below_minimum' => 'bg-gray-100 text-gray-600', 'pending' => 'bg-amber-100 text-amber-700', 'kyc_pending' => 'bg-amber-100 text-amber-700', 'no_bank_account' => 'bg-gray-100 text-gray-600', 'web_only' => 'bg-gray-100 text-gray-600'];
            @endphp
            <tr>

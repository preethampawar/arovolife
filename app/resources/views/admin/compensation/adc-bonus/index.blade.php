...
<div class="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800">
    The ADC Bonus is 3% of the BV attributed to each Arete Development Centre — the BV from orders where a buyer selected the centre as their collection point. Cancellations and refunds automatically net out. Capped at ₹1,00,000/month per centre (per-centre overrides may lower this). Admin charge and TDS are deducted at payout. Runs automatically on the 8th.
</div>
@enddeveloper

...
<div class="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800">
    The ADC Bonus is 3% of the total BV generated by distributors connected to each Arete Development Center, capped at ₹1,00,000/month per center. A 3% admin charge (capped) and 5% TDS are deducted at payout. Runs automatically on the 8th via <code class="font-mono bg-blue-100 px-1 rounded">php artisan adc:monthly-run</code>.
</div>

...
<x-ui.card flush>
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            @empty
                <x-ui.empty-state colspan="6" title="No purchase orders yet.">
                    <x-ui.button href="{{ route('admin.inventory.purchase-orders.create') }}" variant="secondary" size="sm" icon="plus">Create one</x-ui.button>
                </x-ui.empty-state>
            @endforelse
        </tbody>
    </table>

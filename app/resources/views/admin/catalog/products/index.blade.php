        ...
        <tbody class="divide-y divide-gray-100">
            @forelse($products as $product)
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-right text-gray-700">{{ $v ? '₹'.\App\Modules\Shared\Support\IndianNumber::format($v->mrp_paise / 100, 2) : '—' }}</td>
                    <td class="px-4 py-3 text-right text-gray-900 font-medium">{{ $v ? '₹'.\App\Modules\Shared\Support\IndianNumber::format($v->sale_price_paise / 100, 2) : '—' }}</td>
                    <td class="px-4 py-3 text-right text-gray-700">{{ $v ? \App\Modules\Shared\Support\IndianNumber::format($v->bv_paise / 100, 2) : '—' }}</td>
                    <td class="px-4 py-3">
                        @php

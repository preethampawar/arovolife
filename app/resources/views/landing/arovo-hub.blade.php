        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <a href="/p/health-services"
               class="group flex flex-col gap-4 bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-md hover:border-brand-300 transition-all">
                <div class="w-12 h-12 rounded-xl bg-brand-50 flex items-center justify-center text-brand-600 group-hover:bg-brand-100 transition-colors">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Wellness solutions for you and your family.</p>
                </div>
            </a>
            ...
            <a href="/p/social-contribution"
               class="group flex flex-col gap-4 bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-md hover:border-brand-300 transition-all">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Our commitment to community and the environment.</p>
                </div>
            </a>
            ...
            <a href="{{ route('shop.index') }}"
               class="group flex flex-col gap-4 bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-md hover:border-brand-300 transition-all">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Browse our full range of products.</p>
                </div>
            </a>
            ...
            <a href="/p/online-courses"
               class="group flex flex-col gap-4 bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-md hover:border-brand-300 transition-all">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Skill-building programs to support your journey.</p>
                </div>
            </a>
        </div>
    </main>

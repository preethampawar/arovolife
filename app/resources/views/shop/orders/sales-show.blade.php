...
<div>
    <a href="{{ route('orders.sales') }}" class="text-sm text-brand-700 hover:text-brand-800">← Back to my sales</a>

    <div class="flex items-center justify-between mt-3 mb-6 gap-3 flex-wrap">
        <h1 class="text-2xl font-bold text-gray-900">Sale <span class="font-mono text-brand-700">{{ $order->order_no }}</span></h1>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-5 mb-6">
        ...
        <p class="text-xs text-gray-600 mt-0.5">Customer identity details are not disclosed — contact via your referral network.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
        ...
        @if($bv['state'] === 'pending')
        <p class="text-xs text-gray-600 mt-2">BV is counted once payment clears. It is reversed if the customer returns the order.</p>
        @endif
    </div>
    @endif

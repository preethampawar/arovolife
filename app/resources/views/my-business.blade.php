...
<div class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-5 mt-8">
        ...
        <p class="text-xs text-gray-500 mt-2">Your own purchase BV never joins the carry over at the time of purchase. It is added at the 23:59 cut-off, to whichever Genos side is weaker at that moment, and only if a side has reached the first slab that day.</p>
    </div>
    @endif
</div>
@endsection

...
@php
    ...
    $eligibilityNote = $genosBvEligible
        ? 'as of last page load'
        : 'requires '.$gsbMinBv.' BV of personal purchases';
    $eligibilityTipSuffix = ' Genos BV is counted only after your lifetime personal BV reaches '.$gsbMinBv.' BV; until then it shows as 0.';
...
<div class="max-w-5xl mx-auto px-4 py-8">
    ...
    {{-- Group 3 — carry forward / carry over row (Left before Right) --}}
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="{{ $cardClasses }}">
            <div class="flex items-center justify-between mb-1">
                ...
                <x-help-tip text="Business Volume generated by your Left Genos side today — that is, since the last 23:59 cut-off. It does not include BV carried over from earlier days.{{ $eligibilityTipSuffix }}" />
            </div>
        ...
        <div class="{{ $cardClasses }}">
            <div class="flex items-center justify-between mb-1">
                ...
                <x-help-tip text="Business Volume generated by your Right Genos side today — that is, since the last 23:59 cut-off. It does not include BV carried over from earlier days.{{ $eligibilityTipSuffix }}" />
            </div>

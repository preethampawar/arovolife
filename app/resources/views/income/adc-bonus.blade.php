...
<div>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 text-sm text-blue-800 mb-6">
        The ADC Bonus is earned on BV generated by distributors connected to your assigned Arete Development Center — 3% of their combined BV, capped at ₹1,00,000/month. A 3% admin charge (capped) and 5% TDS are deducted at payout. Credited on the 1st of the following month.
    </div>
    @enddeveloper

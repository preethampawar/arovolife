...
<div class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        @php
            $gsbMinBv = $gsbMinBvPaise !== null ? number_format($gsbMinBvPaise / 100, 0) : '600';
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            ...
            <p class="text-2xl font-bold text-gray-900">{{ $genosBvEligible ? ($dailyBv ? number_format($dailyBv->left_bv_paise / 100, 0) : '—') : '0' }}</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            ...
            <p class="text-2xl font-bold text-gray-900">{{ $genosBvEligible ? ($dailyBv ? number_format($dailyBv->right_bv_paise / 100, 0) : '—') : '0' }}</p>
            <p class="text-xs text-gray-400 mt-1">{{ $groupBvNote }}</p>
        </div>
    </div>

...
<div class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 text-sm text-blue-800 mb-6">
        The Fortune Bonus is a monthly matrix reward. Eligible distributors are placed in a 3×9 matrix in order of GSB activity, and each month you earn FB points from the enrolled distributors below you in that matrix. Every qualifier receives a guaranteed ₹30 minimum. On top of that, your FB points are multiplied by your matrix level's point value for the month, up to your level's maximum (₹30,000 at levels 0–3, ₹20,000 at level 4, ₹10,000 at level 5, ₹5,000 at level 6, including the ₹30; levels 7–8 share the remaining pool by points; level 9 receives the ₹30 minimum). A 3% admin charge (Group B, capped) and 5% TDS are deducted at payout. Credited on the 9th of the following month. Every figure below is a record of a completed month.
    </div>
                ...
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="text-right px-4 py-3 font-semibold text-gray-600">
                            FB points × value
                            <x-help-tip text="The whole-rupee point value applied at your matrix level for the month, funded by the fortune pool — 5% of company BV. Your gross includes the guaranteed ₹30 minimum and is limited by your level's maximum." />
                        </th>

...
<div>
    ...
    @else
        <div class="bg-white rounded-2xl border border-gray-200 overflow-x-auto">
            ...
            <p class="px-4 py-2 text-xs text-gray-500 border-t border-gray-100">Income = ₹30 minimum (funded from the month's pool and pro-rated if the pool cannot cover it) + FB points × the level's point value, limited to the level's maximum. The ₹30 is inside the single credit shown here, not a separate line.</p>
        </div>

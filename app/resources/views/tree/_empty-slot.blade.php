...
<button type="button"
    ...
    class="rounded-xl border border-dashed border-gray-300 px-3 py-2 text-[11px] text-gray-400 text-center bg-gray-50/50 cursor-pointer transition-colors hover:border-brand-400 hover:bg-brand-50/60 hover:text-brand-700 min-w-[120px]">

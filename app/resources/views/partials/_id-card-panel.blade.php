    ...
    <dl class="grid grid-cols-[140px_1fr] sm:grid-cols-[160px_1fr] gap-x-3 gap-y-2 text-sm">
        @php
            $rows = [
                ...
                ['label' => 'Left Team',               'value' => \Illuminate\Support\Number::format((int) $idCardStats['left_team'])],
                ['label' => 'Right Team',              'value' => \Illuminate\Support\Number::format((int) $idCardStats['right_team'])],
                ['label' => 'Total Team',              'value' => \Illuminate\Support\Number::format((int) $idCardStats['total_team'])],

...
<div class="mb-4 pb-3 border-b border-gray-100">
    <p class="text-xs text-gray-600 uppercase tracking-wider font-semibold mb-1">Distributor</p>
    <p class="text-lg font-semibold text-gray-900">{{ $idCardStats['name'] }}</p>
    <p class="text-sm text-brand-700 font-mono tracking-wider mt-0.5">{{ $idCardStats['adn'] }}</p>
</div>

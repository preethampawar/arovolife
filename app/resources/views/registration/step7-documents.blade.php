...
@section('title', 'Step 10 — Documents')
...
<div class="max-w-xl mx-auto">
    ...
    <form method="POST" action="{{ url('/register/documents') }}" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-200 p-8 space-y-6">
        ...
        <div>
            ...
            <p class="text-xs text-gray-600 mt-1">{{ $meta['help'] }}</p>
        ...
        <div class="border-t border-gray-100 pt-5 space-y-5">
            <p class="text-xs uppercase tracking-wider text-gray-600 font-medium">Spouse documents</p>
            ...
            <div>
                ...
                <p class="text-xs text-gray-600 mt-1">Front side of your spouse's PAN card.</p>
            ...
            <div>
                ...
                <p class="text-xs text-gray-600 mt-1">Or e-Aadhaar PDF from UIDAI.</p>

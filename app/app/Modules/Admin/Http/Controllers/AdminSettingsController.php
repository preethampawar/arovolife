    ...
    public static function registry(): array
    {
        return [
            ...
            'offers.activation_bv_paise' => [
                ...
                'label' => 'Offer activation threshold',
                'description' => 'Lifetime personal BV a distributor must reach before the half-price product offer applies. The Retailer title sits at 3,000 BV. BV is stored at 100 paise to the BV — edit in paise.',
                'display_unit' => 'bv',
                'type' => 'int',
                'min' => 0,
                'max' => 100_000_000,
            ...
            'offers.qualifying_bv_paise' => [
                ...
                'owner' => 'developer',
                'feature' => PurchaseOffersFeature::class,
                'label' => 'Monthly qualifying volume',
                'description' => 'Personal BV a distributor must purchase in a month for it to count towards both offers. A refund in the month reduces it, so a returned purchase does not keep a month qualifying. Edit in paise (100 paise = 1 BV).',
                'display_unit' => 'bv',
                'type' => 'int',
                'min' => 0,
                'max' => 100_000_000,
            ...
            // ── Action Center — SLA windows and snooze cap ──────────────────
            'action_center.pack_sla_hours' => [
                'group' => 'advanced',
                'owner' => 'developer',
                'label' => 'Order pack SLA (hours)',
                'description' => 'Hours from payment to pack. Orders exceeding this window are flagged as WARNING; older than 1.5x become CRITICAL.',
                'impact' => 'Changes affect only new queries; in-flight items keep their current severity until the cache expires (60 seconds).',
                'type' => 'int',
                'min' => 1,
                'max' => 168,
                'default' => '24',
            ],
            'action_center.ship_sla_hours' => [
                'group' => 'advanced',
                'owner' => 'developer',
                'label' => 'Order ship SLA (hours)',
                'description' => 'Hours from pack to ship. Orders exceeding this window are flagged as WARNING.',
                'type' => 'int',
                'min' => 1,
                'max' => 168,
                'default' => '24',
            ],
            'action_center.delivery_chase_days' => [
                'group' => 'advanced',
                'owner' => 'developer',
                'label' => 'Delivery chase (days)',
                'description' => 'Days from ship to delivery. Orders exceeding this window are flagged as WARNING.',
                'type' => 'int',
                'min' => 1,
                'max' => 90,
                'default' => '7',
            ],
            'action_center.transfer_transit_days' => [
                'group' => 'advanced',
                'owner' => 'developer',
                'label' => 'Stock transfer in-transit (days)',
                'description' => 'Days from stock transfer dispatch to receipt. Transfers exceeding this window are flagged as WARNING.',
                'type' => 'int',
                'min' => 1,
                'max' => 90,
                'default' => '5',
            ],
            'action_center.grn_draft_days' => [
                'group' => 'advanced',
                'owner' => 'developer',
                'label' => 'GRN draft age (days)',
                'description' => 'Days from GRN posting to stale alert. Posted invoices older than this are flagged as INFO.',
                'type' => 'int',
                'min' => 1,
                'max' => 30,
                'default' => '3',
            ],
            'action_center.po_overdue_days' => [
                'group' => 'advanced',
                'owner' => 'developer',
                'label' => 'Purchase order overdue (days)',
                'description' => 'Days from PO send (or expected_at date) to overdue alert. POs exceeding this window are flagged as INFO.',
                'type' => 'int',
                'min' => 1,
                'max' => 90,
                'default' => '7',
            ],
            'action_center.kyc_review_hours' => [
                'group' => 'advanced',
                'owner' => 'developer',
                'label' => 'KYC review SLA (hours)',
                'description' => 'Hours from KYC submission to review alert. Submissions exceeding this window are flagged as WARNING.',
                'type' => 'int',
                'min' => 1,
                'max' => 168,
                'default' => '48',
            ],
            'action_center.max_snooze_days' => [
                'group' => 'advanced',
                'owner' => 'developer',
                'label' => 'Maximum snooze window (days)',
                'description' => 'The maximum number of days a manager may defer an action. Snooze requests with more days are clamped to this cap. Statutory actions cannot be snoozed at all.',
                'type' => 'int',
                'min' => 1,
                'max' => 90,
                'default' => '30',
            ...
            'payout.min_threshold_paise' => [
                ...
                'description' => 'Wallet balances below this amount roll over to the next payout batch. Stored in paise — edit in paise (100 paise = ₹1). KP-confirmed minimum is ₹100.',
                'display_unit' => 'rupees',
                'type' => 'int',
                'min' => 1,
                'max' => 10000000,
            ...
            'payout.neft_min_bv_paise' => [
                'group' => 'payout',
                'label' => 'NEFT eligibility — minimum personal BV',
                'description' => 'Lifetime personal BV a distributor must reach for wallet credits to transfer via NEFT. Below this threshold credits are held as web-only balance. The Retailer title sits at 3,000 BV. Edit in paise (100 paise = 1 BV).',
            ...
            'payout.gateway' => [
                ...
                'description' => 'How approved payout batches actually reach distributors\' banks. **Manual NEFT** exports a CSV that finance uploads to the company bank, then imports the bank\'s response file back. **Razorpay Payouts** hands every line item to the RazorpayX API on approval and settles each transfer from the payout webhook.',
                'impact' => 'Applies from the next batch approved. Batches already approved continue on the route they were approved under. Razorpay Payouts also needs RAZORPAYX_* credentials in the environment — without them approval will fail every line item.',
                'type' => 'enum',
                'options' => [
                    ['value' => 'manual_neft', 'label' => 'Manual NEFT (CSV export and response import)', 'note' => 'No money moves without a human uploading the file to the bank.'],
                    ['value' => 'razorpay', 'label' => 'Razorpay Payouts (RazorpayX API)', 'note' => 'Approving a batch initiates real bank transfers immediately.'],
                ],
                'default' => 'manual_neft',
            ],
            'payout.razorpay.transfer_mode' => [
                'group' => 'payout',
                'label' => 'Razorpay transfer rail',
                'description' => 'Which payment rail Razorpay uses for each transfer. NEFT settles in batches through the day and carries no per-transaction ceiling. IMPS is instant and around the clock but is capped at ₹5,00,000 per transfer — anything larger is sent on NEFT automatically. RTGS is same-day for high-value transfers.',
                'impact' => 'Applies to payouts dispatched after the change. Does not affect transfers already with the gateway.',
                'type' => 'enum',
                'options' => [
                    ['value' => 'NEFT', 'label' => 'NEFT', 'note' => 'Default. No per-transaction limit; settles in half-hourly bank batches.'],
                    ['value' => 'IMPS', 'label' => 'IMPS', 'note' => 'Instant, 24×7. Transfers above ₹5,00,000 fall back to NEFT.'],
                    ['value' => 'RTGS', 'label' => 'RTGS', 'note' => 'High-value, same-day. Bank hours only.'],
                ],
                'default' => 'NEFT',
            ],
            'payout.razorpay.narration' => [
                'group' => 'payout',
                'label' => 'Bank statement narration',
                'description' => 'The text a distributor sees against this credit on their own bank statement. Letters, digits and spaces only, up to 30 characters — the banking rails reject anything else.',
                'impact' => 'Applies to payouts dispatched after the change.',
                'type' => 'string',
                'max' => 30,
                'default' => 'Arovolife Commission',
            ],
            'payout.razorpay.max_retries' => [
                'group' => 'payout',
                'label' => 'Failed payout — maximum retries',
                'description' => 'How many times a failed transfer may be re-sent before it stops being retried automatically and waits for someone to look at it. Retries do not fix wrong bank details; they recover gateway blips and short balances.',
                'impact' => 'Applies to the next auto-retry sweep. Line items already past the new limit simply stop being picked up.',
                'type' => 'int',
                'min' => 1,
                'max' => 5,
                'default' => '3',
            ],
            'payout.razorpay.auto_retry_hours' => [
                'group' => 'payout',
                'label' => 'Failed payout — hours before auto-retry',
                'description' => 'How long a failed transfer must sit untouched before the nightly sweep re-sends it. Long enough that a transient gateway fault has cleared; short enough that a distributor is not left waiting a week.',
                'impact' => 'Applies to the next auto-retry sweep (daily, 11:00 IST).',
                'type' => 'int',
                'min' => 1,
                'max' => 168,
                'default' => '24',
            ...
            'comp.admin_charge.weekly_cap_paise' => [
                'group' => 'compensation_plan',
                'label' => 'Admin charge cap — weekly batch',
                'description' => 'Maximum admin charge per distributor in each weekly payout batch (Group A: GSB + Mentorship). Edit in paise (100 paise = ₹1). KP-confirmed: ₹25,000.',
            ...
            'comp.monthly_income_cap_paise' => [
                'group' => 'compensation_plan',
                'label' => 'Monthly income cap',
                'description' => 'Per-distributor income cap per month (KP Round-4). In the monthly payout batch, Rank-bonus income above this is trimmed to the cap. Edit in paise (100 paise = ₹1). KP-confirmed: ₹50,00,000.',
            ...
            'comp.gsb.min_bv_paise' => [
                'group' => 'compensation_plan',
                'feature' => GenosSalesBonusFeature::class,
                'label' => 'Personal-BV minimum for income',
                'description' => 'Lifetime personal purchase BV a distributor must reach before Genos BV accrues to them at all. KP §14: 600 BV. Below this, downline BV is not added to their account; from 600 BV income accrues but stays web-only until the 3,000 BV Retailer title releases it to bank. Edit in paise (100 paise = 1 BV).',
            ...
            'comp.gsb.power_cf_cap_paise' => [
                'group' => 'compensation_plan',
                'feature' => GenosSalesBonusFeature::class,
                'label' => 'GSB power-side carry-forward cap',
                'description' => 'Maximum BV carried forward on the stronger Genos side after a bonus. Excess is flushed. Edit in paise (100 paise = 1 BV).',
                'display_unit' => 'bv',
                'type' => 'int',
                'min' => 0,
                'max' => 100_000_000_000,
            ...
            'comp.adc.cap_paise' => [
                'group' => 'compensation_plan',
                'feature' => AreteDevelopmentCenterBonusFeature::class,
                'label' => 'Arete Development Center monthly cap',
                'description' => 'Maximum ADC bonus per center per month. Edit in paise (100 paise = ₹1). Default: ₹1,00,000.',
                'display_unit' => 'rupees',
                'type' => 'int',
                'min' => 0,
                'max' => 10_000_000_000,
            ...
            'comp.repurchase.rate_bp' => [
                ...
                'description' => 'Share of GSB + GBB + Fortune + Rank bonuses moved to the repurchase wallet as each is credited. 1000 = 10%.',
                'type' => 'int',
                'min' => 0,
                'max' => 10000,
                'default' => '1000',
            ...
            'comp.repurchase.cap_paise' => [
                'group' => 'compensation_plan',
                'feature' => RepurchaseEngineFeature::class,
                'label' => 'Repurchase wallet cap',
                'description' => 'Maximum repurchase-wallet deduction per distributor per calendar month, counted against the month the income was earned for. Edit in paise (100 paise = ₹1). Default: ₹10,000.',
                'display_unit' => 'rupees',
                'type' => 'int',
                'min' => 0,
                'max' => 1_000_000_000,
            ...
            'comp.repurchase.non_ranked_bv_paise' => [
                'group' => 'compensation_plan',
                'feature' => RepurchaseEngineFeature::class,
                'label' => 'Repurchase BV — non-ranked',
                'description' => 'Monthly repurchase BV a distributor with no rank must complete to stay income-eligible. Default: 600 BV. Per-rank values (R1 1,000 … R9 2,300) are edited on the Compensation → Plan settings page. Edit in paise (100 paise = 1 BV).',
                'display_unit' => 'bv',
                'type' => 'int',
                'min' => 0,
                'max' => 1_000_000_000,
            ...
            'comp.fortune.min_commission_paise' => [
                'group' => 'compensation_plan',
                'feature' => FortuneBonusFeature::class,
                'label' => 'Fortune Bonus minimum commission',
                'description' => 'Guaranteed amount every Fortune Bonus qualifier receives, reserved off the pool before the level cascade distributes. Level caps INCLUDE this minimum. KP: ₹30. If a month\'s pool cannot cover it, every qualifier gets the same pro-rated whole-rupee share instead. Edit in paise (100 paise = ₹1).',

 ...
 *
 * Earning: 3% on BV generated by all active members of each center in the month.
 * Cap: ₹1,00,000/month (10,000,000 paise) per center.
 * Admin charge: NOT applicable (exempt per plan).
 * TDS: 5% on gross.
    ...
    public function runForMonth(Carbon $month): array
    {
        ...
        DB::transaction(function () use ($centers, $monthStart, $monthEnd, &$credited, &$skippedNoBv, &$totalNet): void {
            foreach ($centers as $center) {
                ...
                $gross = min((int) floor($totalBv * AdcBonusResult::BONUS_RATE), AdcBonusResult::MONTHLY_CAP_PAISE);

...
/**
 * Gates the two purchase offers (client, 2026-06-26) — the half-price monthly
 ...
 *  2. `/p/compensation` §11.1 carries the effective date from that notice; and
 *  3. the client confirms the two readings recorded in R-48 — what "hold no rank"

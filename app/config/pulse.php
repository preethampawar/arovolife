...
return [
    ...
    */
    ...
    'middleware' => [
        'web',
        'auth',
        // Pulse surfaces slow queries, exception traces and job payloads, so it
        // is a developer-only surface like the rest of them. `role:developer`
        // and not a Gate alone: AppServiceProvider's Gate::before grants every
        // ability to admins, so a gate check by itself would let them in.
        'role:developer',
        Authorize::class,
    ],

...
export const SKIP = {
    ...
    '/my/arete-centre/apply': 'returns 500 on this dev database — a PII column on the fixture\'s row was seeded outside PiiCrypter, so the prefill throws DecryptException. Pre-existing, unrelated to the theme; see the outcome section of the plan.',
